pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/harri581'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/harri581/225-lab3-5.git'                                          //<------change this
        KUBECONFIG = credentials('harri581-225')                                                         //<------change this
    }
